    ...
    <section className="w-full px-4 py-16">
      <div className="mx-auto max-w-5xl">
        <div className="rounded-2xl bg-[#172D5C] px-8 py-16 text-center text-white md:px-16">
          {/* Main Heading */}
          <h2 className="font-glacial mb-8 text-3xl leading-relaxed md:text-5xl lg:text-6xl">
            {t('mainHeading1')}
            <br />
            {t('mainHeading2')}
          ...
          {/* Description */}
          <div className="font-glacial mx-auto mb-8 max-w-4xl space-y-6 text-lg font-medium leading-relaxed text-zinc-300 md:text-2xl lg:mb-20 lg:text-2xl">
            <p>{t('description1')}</p>
            <p>{t('description2')}</p>
          </div>
