...
const CARD_SERVICES_DATADOWN = [
  {
    title: 'SAPDevelopers',
    description: 'SAPDevelopersDetails',
  },
  {
    title: 'digitalDevelopers',
    description: 'digitalDevelopersDetails',
  },
]
    ...
    <>
      ...
      <div className="mx-auto mt-[-156px] w-full px-6 sm:mt-[-232px] md:mt-[-200px]">
        <div className="mx-auto mb-4 grid max-w-[1280px] grid-cols-1 justify-items-center gap-4 lg:grid-cols-3">
          {CARD_SERVICES_DATAUP.map((data, index) => (
            <CardServices
              title={data.title}
        ...
        <div className="mx-auto grid max-w-[1280px] grid-cols-1 justify-items-center gap-4 lg:grid-cols-2">
          {CARD_SERVICES_DATADOWN.map((data, index) => (
            <CardServices
              title={data.title}
              description={data.description}
              key={index}
